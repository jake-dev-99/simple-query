...
import 'package:simple_query_windows/simple_query_windows.dart';
...
void main() {
  ...
  test('registerWith sets platform instance', () {
    SimpleQueryWindows.registerWith();
    expect(SimpleQueryPlatform.instance, isA<SimpleQueryWindows>());
  });
  ...
  test('capability matrix matches Windows current implementation', () async {
    SimpleQueryWindows.registerWith();
  ...
  test('files query returns typed records', () async {
    ...
    final temp =
        await Directory.systemTemp.createTemp('simple_query_windows_query_');
  ...
  test('media query returns typed records', () async {
    ...
    final temp =
        await Directory.systemTemp.createTemp('simple_query_windows_media_');
  ...
  test('update mutation writes file content for files domain', () async {
    ...
    final temp =
        await Directory.systemTemp.createTemp('simple_query_windows_update_');
    final file = File('${temp.path}${Platform.pathSeparator}sample.txt');
  ...
  test('batch fallback is sequential best effort', () async {
    ...
    final temp =
        await Directory.systemTemp.createTemp('simple_query_windows_batch_');
  ...
  test('observe files supports subscribe and cancel lifecycle', () async {
    ...
    final temp =
        await Directory.systemTemp.createTemp('simple_query_windows_observe_');
  ...
  test('openBinary and closeBinary lifecycle succeeds for files domain',
    ...
    final temp =
        await Directory.systemTemp.createTemp('simple_query_windows_binary_');
  ...
  test('callExtension supports windows.storage resolveKnownFolders', () async {
    SimpleQueryWindows.registerWith();
  ...
  test('callExtension invalid args return invalidQuery', () async {
    ...
    expect(
      () => SimpleQueryPlatform.instance.callExtension(
        namespace: 'windows.storage',
        method: 'resolveKnownFolders',
        args: <String, Object?>{'includeTemp': 'bad'},
      ),
      throwsA(
        isA<SimpleQueryError>()
  ...
  test('files query with explicit rootPath succeeds', () async {
    SimpleQueryWindows.registerWith();
    final tmpDir = Directory.systemTemp.createTempSync('simple_query_win_');
